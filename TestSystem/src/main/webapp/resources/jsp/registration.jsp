...
<div class="form-style-8">
    ...
    <div>
        <form action="signUp" method="post">
            ...
            <input type="text" id="firstName" name="firstName" placeholder="<locale:message code="label.firstName"/>"/>
            <input type="text" id="lastName" name="lastName" placeholder="<locale:message code="label.lastName"/>"/>
